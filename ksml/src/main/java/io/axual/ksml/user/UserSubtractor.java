...
import io.stoatflow.core.topology.Subtractor;

public class UserSubtractor extends Invoker implements Subtractor<Object, Object, Object> {
    private static final NativeDataObjectMapper NATIVE_MAPPER = new DataObjectFlattener();

    public UserSubtractor(UserFunction function, MetricTags tags) {
