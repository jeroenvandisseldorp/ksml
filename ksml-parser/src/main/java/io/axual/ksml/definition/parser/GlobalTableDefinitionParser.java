...
public class GlobalTableDefinitionParser extends BaseTableDefinitionParser<GlobalTableDefinition> {
    public GlobalTableDefinitionParser(ParseContext context, TopologyBaseResources resources, boolean isJoinTarget) {
        super(context, resources, isJoinTarget, "globalTable");
    }
