...
public class TopologyBaseResourcesParser extends DefinitionParser<TopologyBaseResources> {
    ...
    public TopologyBaseResourcesParser(ParseContext context, String namespace) {
        super(context);
    ...
    public StructsParser<TopologyBaseResources> parser() {
        return structsParser(
                ...
                optional(mapField(STORES, "store", "state store definition", "State stores that can be referenced in producers and pipelines", new StateStoreDefinitionParser(context, true))),
                optional(mapField(FUNCTIONS, "function", "function definition", "Functions that can be referenced in producers and pipelines", new TypedFunctionDefinitionParser(context))),
