...
import static io.axual.ksml.function.FunctionDefinitionDSL.NO_PARAMETERS;
...
public class GeneratorDefinition extends FunctionDefinition {
    public static final DataType EXPECTED_RESULT_TYPE = new UnionType(
            new UnionType.Member("singleMessage", new TupleType(DataType.UNKNOWN, DataType.UNKNOWN), "Single message", 1),
            new UnionType.Member("listOfMessages", new ListType(new TupleType(DataType.UNKNOWN, DataType.UNKNOWN)), "List of messages", 2));
