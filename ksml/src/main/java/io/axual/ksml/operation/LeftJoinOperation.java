...
public class LeftJoinOperation extends BaseJoinOperation {
    ...
    public LeftJoinOperation(StoreOperationConfig config, TopologyResource<TopicDefinition> joinStream, TopologyResource<FunctionDefinition> valueJoiner, Duration timeDifference, Duration gracePeriod) {
        super(config);
    ...
    public LeftJoinOperation(StoreOperationConfig config, TopologyResource<TopicDefinition> joinTable, TopologyResource<FunctionDefinition> foreignKeyExtractor, TopologyResource<FunctionDefinition> valueJoiner, Duration gracePeriod, TopologyResource<FunctionDefinition> partitioner, TopologyResource<FunctionDefinition> otherPartitioner) {
        super(config);
    ...
    public LeftJoinOperation(StoreOperationConfig config, TopologyResource<TopicDefinition> joinTable, TopologyResource<FunctionDefinition> keySelector, TopologyResource<FunctionDefinition> valueJoiner) {
        super(config);
        this.joinTopic = joinTable;
