...
class FilterProcessorTest {
    ...
    @Test
    @DisplayName("filter forwards the record when the predicate evaluates to true")
    void forwardsRecordWhenPredicateIsTrue() {
        final var processor = new FilterProcessor("filter", (stores, rec) -> true, NO_STORES);
    ...
    @Test
    @DisplayName("filter drops the record when the predicate evaluates to false")
    void dropsRecordWhenPredicateIsFalse() {
        final var processor = new FilterProcessor("filter", (stores, rec) -> false, NO_STORES);
        processor.init(context);
