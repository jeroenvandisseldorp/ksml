...
public class JoinWithStreamOperation extends DualStoreOperation {
    ...
    public JoinWithStreamOperation(DualStoreOperationConfig config, StreamDefinition joinStream, FunctionDefinition valueJoiner, Duration timeDifference, Duration gracePeriod) {
        super(config);
