...
class KeyValueStoreProxyTest {
    ...
    void nameDelegates() {
        when(delegate.getName()).thenReturn("myStore");
        assertThat(proxy().getName()).isEqualTo("myStore");
    }

    @Test
    @DisplayName("isOpen delegates to the wrapped store")
    void isOpenDelegates() {
    ...
    @Test
    @DisplayName("init forwards the context to the wrapped store")
    void initDelegates() {
