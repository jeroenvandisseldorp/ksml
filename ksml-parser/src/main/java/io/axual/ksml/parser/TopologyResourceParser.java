...
public class TopologyResourceParser<T, F extends T> extends DefinitionParser<TopologyResource<T>> {
    ...
    public TopologyResourceParser(ParseContext context, String resourceType, String childName, String doc, BiFunction<String, MetricTags, T> lookup, StructsParser<F> inlineParser) {
        this(context, resourceType, childName, doc, lookup, inlineParser, false);
    }

    public TopologyResourceParser(ParseContext context, String resourceType, String childName, String doc, BiFunction<String, MetricTags, T> lookup, StructsParser<F> inlineParser, boolean allowLookupFail) {
        super(context);
