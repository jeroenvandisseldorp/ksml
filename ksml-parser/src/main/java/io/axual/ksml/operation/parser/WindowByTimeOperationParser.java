...
import io.axual.ksml.operation.WindowByTimeOperationDefinition;
...
public class WindowByTimeOperationParser extends OperationParser<WindowByTimeOperationDefinition> {
    private static final String DOC = "Operation to window records based on time criteria";
    private final StructsParser<WindowByTimeOperationDefinition> tumblingParser;
    private final StructsParser<WindowByTimeOperationDefinition> hoppingParser;
    private final StructsParser<WindowByTimeOperationDefinition> slidingParser;

    public WindowByTimeOperationParser(ParseContext context, TopologyResources resources) {
        super(context, KSMLDSL.Operations.WINDOW_BY_TIME, resources);
        ...
        tumblingParser = structsParser(
                WindowByTimeOperationDefinition.class,
                "WithTumblingWindow",
                DOC,
                operationNameField(),
                durationParser,
                ...
                (name, duration, grace, tags) -> {
                    ...
                    return new WindowByTimeOperationDefinition(operationConfig(name, tags), timeWindows);
                });
        ...
        slidingParser = structsParser(
                ...
                (name, timeDifference, grace, tags) -> {
                    ...
                    return new WindowByTimeOperationDefinition(operationConfig(name, tags), slidingWindows);
                });
    }

    @Override
    public StructsParser<WindowByTimeOperationDefinition> parser() {
