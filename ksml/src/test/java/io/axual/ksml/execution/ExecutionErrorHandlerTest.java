...
class ExecutionErrorHandlerTest {
    ...
    void delegatesDeserializationHandling() {
        ...
        assertThat(handler.handle(context, rec, new RuntimeException("boom")).getResult())
    ...
    void delegatesProcessingHandling() {
        assertThat(handler.handle(context, new Record<>("k", "v", 0L), new RuntimeException("boom")).getResult())
