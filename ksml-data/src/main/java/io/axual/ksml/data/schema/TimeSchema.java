...
/**
 * A schema representation for time-of-day values in the KSML framework.
 * <p>
 * The {@code TimeSchema} class extends the {@link DataSchema} and is used to define
 * schemas for time-of-day values. It provides a {@code unit} attribute that specifies
 * the unit of the time-of-day value.
 * </p>
 */
@Getter
@EqualsAndHashCode
public class TimeSchema extends DataSchema {
    public enum Unit {
        NANOSECONDS, MICROSECONDS, MILLISECONDS
    }

    /**
     * The unit of the time-of-day value represented by this schema.
     */
    private final Unit unit;

    /**
     * Constructs a {@code TimeSchema} with the given unit.
     *
     * @param unit The unit of the time
     */
    public TimeSchema(Unit unit) {
     ...
     * this {@code TimeSchema}. Compatibility typically means that the other schema has
    ...
    public Assignable isAssignableFrom(DataSchema otherSchema) {
        ...
        if (!(otherSchema instanceof TimeSchema)) return schemaMismatch(this, otherSchema);
