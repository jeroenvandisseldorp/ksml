...
public class JoinWithStreamOperation extends DualStoreOperation<JoinWithStreamOperationDefinition> {
    private static final String VALUEJOINER_NAME = "ValueJoiner";

    public JoinWithStreamOperation(JoinWithStreamOperationDefinition definition) {
        super(definition);
    }
