...
import io.axual.ksml.function.KeyValueMapperDefinition;
...
public class KeyValueMapperDefinitionParser extends FunctionDefinitionParser<KeyValueMapperDefinition> {
    public KeyValueMapperDefinitionParser(ParseContext context, boolean requireType) {
        super(context, requireType);
    }

    @Override
    public StructsParser<KeyValueMapperDefinition> parser() {
