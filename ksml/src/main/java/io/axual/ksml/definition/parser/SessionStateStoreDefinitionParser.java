...
public class SessionStateStoreDefinitionParser extends MultiFormParser<SessionStateStoreDefinition> implements NamedObjectParser {
    ...
    @Override
    protected MultiSchemaParser<SessionStateStoreDefinition> parser() {
        return structParser(
