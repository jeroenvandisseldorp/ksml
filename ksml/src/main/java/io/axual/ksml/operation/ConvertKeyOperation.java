...
public class ConvertKeyOperation extends BaseOperation<ConvertKeyOperationDefinition> {
    public ConvertKeyOperation(ConvertKeyOperationDefinition definition) {
        super(definition);
    }
