...
class KSMLRunnerQuerierTest {
    ...
    void delegatesStoreQueriesToKafkaStreams() {
        final var kafkaStreams = mock(StoatFlow.class);
        final var streamsRunner = mock(KafkaStreamsRunner.class);
    ...
    void delegatesKeyMetadataAndStoreQueries() {
        ...
        final var keyMetadata = mock(io.stoatflow.core.KeyQueryMetadata.class);
        ...
        final var params = io.stoatflow.core.state.StoreQueryParameters
                .fromNameAndType("store", io.stoatflow.core.state.QueryableStoreTypes.<String, String>keyValueStore());
        final io.stoatflow.core.state.ReadOnlyKeyValueStore<String, String> store = mock(io.stoatflow.core.state.ReadOnlyKeyValueStore.class);
