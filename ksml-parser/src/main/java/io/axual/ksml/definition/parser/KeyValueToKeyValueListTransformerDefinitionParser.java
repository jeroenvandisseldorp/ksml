...
import io.axual.ksml.function.KeyValueToKeyValueListTransformerDefinition;
...
public class KeyValueToKeyValueListTransformerDefinitionParser extends FunctionDefinitionParser<KeyValueToKeyValueListTransformerDefinition> {
    public KeyValueToKeyValueListTransformerDefinitionParser(ParseContext context, boolean requireType) {
