...
import io.axual.ksml.function.KeyValueToValueListTransformerDefinition;
...
public class KeyValueToValueListTransformerDefinitionParser extends FunctionDefinitionParser<KeyValueToValueListTransformerDefinition> {
    public KeyValueToValueListTransformerDefinitionParser(ParseContext context, boolean requireType) {
