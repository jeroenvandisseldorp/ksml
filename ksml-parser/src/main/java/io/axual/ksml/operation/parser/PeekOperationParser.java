...
public class PeekOperationParser extends OperationParser<PeekOperationDefinition> {
    public PeekOperationParser(ParseContext context, TopologyResources resources) {
        super(context, KSMLDSL.Operations.PEEK, resources);
    }
    ...
    public StructsParser<PeekOperationDefinition> parser() {
        return structsParser(
                ...
                (name, action, tags) -> new PeekOperationDefinition(operationConfig(name, tags), action));
    }
}
