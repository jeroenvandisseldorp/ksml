...
public class WindowStateStoreDefinitionParser extends MultiFormParser<WindowStateStoreDefinition> implements NamedObjectParser {
    ...
    @Override
    protected MultiSchemaParser<WindowStateStoreDefinition> parser() {
        return structParser(
